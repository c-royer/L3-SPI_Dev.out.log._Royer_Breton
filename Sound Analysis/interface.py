...
class Plot2D:
    ...
    def trace(self,name,dataset_x,dataset_y, freq):
        ...
        if name in self.traces:
            ...
            if name == 'waveform':
                color1 = color.royalblue # allows to change the color of the second plot
                self.traces[name] = self.waveform.plot(pen=color1[1], width=2)
            ...
            if name == 'spectrum':
                color2 = color.firebrick # allows to change the color of the second plot
                self.traces[name] = self.spectrum.plot(pen=color2[1], width=2)
